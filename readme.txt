...
= 0.1.3 =
Minor bugfixes that make WordPress a little bit happier, but don't affect overall functionality.

= 0.1.2 =
File header meta edited to allow use with [GitHub Updater](https://github.com/afragen/github-updater).

= 0.1.1 =
Better handling of Section Title markup. If the feild is left blank, no HTML is generated for it. This creates a much cleaner and more adaptable markup output. 